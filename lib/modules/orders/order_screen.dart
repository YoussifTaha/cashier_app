...
class _OrderScreenState extends State<OrderScreen> {
  ...
  void initState() {
    super.initState();
    db = FirebaseDatabase.instance.ref().child('orders');
                                        ...
                                        var data = {
                                          ...
                                          'notification': {
                                            'title': lang == 'ar'
                                                ...
                                                : 'Order confirmation',
                                            'body': lang == 'ar'
                                                ? 'تم تأكيد طلبك و سيتم تجهيزه الأن'
                                                : 'Your order has been confirmed and It\'s being prpared now',
                                          }
                                        };
                                        await http.post(
                                          Uri.parse(
